...
//  FaceIt
//
//  Created by Dong, Vincent on 10/20/17.
...
class ExpressionEditorViewController: UITableViewController, UITextFieldDelegate {
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        if identifier == "Add Emotion", name.isEmpty {
            ...
            return super.shouldPerformSegue(withIdentifier: identifier, sender: sender) //give super a chance
        }
    }
    
    private func handleUnnameFace() {
        ...
        alert.addTextField { textField in
            textField.placeholder = "Give a name to the face"
        }
